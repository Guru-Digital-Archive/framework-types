...
class DateTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        date_default_timezone_set(Settings\DefaultDateSettings::$defaultTimeZone);
    }
    ...
    /**
     * @covers GDM\Framework\Types\Date::roundMinutesUp()
     * @covers GDM\Framework\Types\Date::roundMinutes()
     */
    public function testRoundMinutes()
    {
        $this->object->setTime(1, 1);
        $this->object->roundMinutes();
        $this->assertEquals(00, $this->object->format('i'));
        $this->object->setTime(1, 31);
        $this->object->roundMinutes(20);
        $this->assertEquals(40, $this->object->format('i'));
        $this->object->setTime(1, 55);
        $this->object->roundMinutes(10);
        $this->assertEquals(0, $this->object->format('i'));
    }
     ...
     * @covers GDM\Framework\Types\Date::roundMinutes()
     */
    public function testRoundMinutesUp()
    {
        $this->object->setTime(1, 1);
        $this->object->roundMinutesUp();
        $this->assertEquals(15, $this->object->format('i'));
        $this->object->setTime(1, 31);
        $this->object->roundMinutesUp(20);
        $this->assertEquals(40, $this->object->format('i'));
        $this->object->setTime(1, 55);
        $this->object->roundMinutesUp(10);
        $this->assertEquals(0, $this->object->format('i'));
    }

    /**
     * @covers GDM\Framework\Types\Date::roundMinutesDown()
     * @covers GDM\Framework\Types\Date::roundMinutes()
     */
    public function testRoundMinutesDown()
    {
        $this->object->setTime(1, 1);
        $this->object->roundMinutesDown();
        $this->assertEquals(00, $this->object->format('i'));
        $this->object->setTime(1, 31);
        $this->object->roundMinutesDown(20);
        $this->assertEquals(20, $this->object->format('i'));
        $this->object->setTime(1, 55);
        $this->object->roundMinutesDown(10);
        $this->assertEquals(50, $this->object->format('i'));
    }
